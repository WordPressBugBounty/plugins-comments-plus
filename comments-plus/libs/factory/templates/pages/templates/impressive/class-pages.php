...
class PageBase extends \WBCR\Factory_Templates_134\Impressive {
	...
	public function showRatingWidget(array $args)
	{
		...
		<div class="wbcr-factory-sidebar-widget">
			<strong><?php esc_html_e( 'Leave a review:', 'comments-plus' ); ?></strong>
			<?php esc_html_e( 'Liking the plugin? A quick review would mean a lot and helps us make it even better.', 'comments-plus' ); ?>
			<span>
				<i class="dashicons dashicons-star-filled"></i>
				<a class="wbcr-leave-review-link" href="<?php echo $page_url; ?>" title="Go rate us" target="_blank">
					<?php esc_html_e( 'Leave a Review', 'comments-plus' ); ?>
				</a>
			</span>
		</div>
		<?php
